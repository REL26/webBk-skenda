...
oleh tim siswa SahDu yang diketuai FAREL (2025–2026)
-->
    ...
    <div class="bg-white rounded-2xl shadow-2xl
      ...
      <div class="bg-gradient-to-br from-gray-900 to-gray-800
        ...
        <h1 class="text-3xl font-bold leading-tight mb-5">
          Layanan Bimbingan dan Konseling Digital
        </h1>

        <p class="text-gray-300 mb-8 leading-relaxed">
          Platform resmi Bimbingan dan Konseling SMKN 2 Banjarmasin

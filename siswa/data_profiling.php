    ...
    <section class="py-8 md:py-10 px-4 flex-grow">
        <div class="max-w-7xl mx-auto bg-white p-6 md:p-8 rounded-xl shadow-2xl border border-gray-200 print-area">
            ...
            <div class="no-print mb-8 flex flex-wrap justify-between items-center gap-3">
                <a href="cv_template.php" id="btnSiswaExport" class="btn-print-cv bg-indigo-500 hover:bg-indigo-600 text-white group inline-flex items-center gap-4 px-6 py-3.5 rounded-2xl transition-all duration-300">
            ...
            <form id="formProfiling" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 items-start mb-10">
                    ...
                    <div class="md:col-span-3 space-y-6">
                        <div class="bg-blue-50 p-5 rounded-xl border-2 border-blue-200 mt-7 shadow-inner">

...
$config = require __DIR__ . '/config_asesmen_xi.php';
$versi  = 'XI';
...
$localStorageKey = 'testAnswers_asesmenXI_siswa' . $id_siswa;
...
<script>
    ...
    function goToNav(index) {
        if (index === totalQuestions) { showQuestion(index); return; } 
    ...
    function showQuestion(index) {
        ...
        if (index < totalQuestions && index > maxReachedIndex) {

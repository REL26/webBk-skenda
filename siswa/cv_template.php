...
// $tipe_kepribadian = htmlspecialchars(str_replace('Tes ', '', $siswa['hasil_tes_kepribadian'] ?? 'Belum Mengisi'));
?>
<!DOCTYPE html>
<html lang="id">
<head>
        ...
        <div class="left-content">
            ...
            <div class="section">
                ...
                <div class="detail-list">
                    ...
                    <!-- <p class="detail-item"><strong>Tipe Kepribadian</strong> : <?php echo $tipe_kepribadian; ?></p> -->
                </div>
            </div>
        </div>

        <div class="right-content me-7">
            <div class="section">
...
<div class="no-print">
    <a href="data_profiling.php" class="btn bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 transition duration-150 ease-in-out">

...
<body class="bg-gray-50 antialiased leading-relaxed">
    ...
    <div class="w-full max-w-2xl bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <p class="text-lg text-gray-600 text-center mb-10">
            ...
            Anda sedang melihat laporan Tes Kemampuan untuk siswa:
        ...
        <div id="report-content">
            ...
            <div class="tanda-tangan mt-10 flex justify-between text-[10.5pt] flex-col gap-5">
                <div class="w-full text-center lg:w-[45%]">
                    ...
                    <div class="h-10"></div>
                    <div class="ttd-placeholder mt-6 leading-loose underline font-bold"><?= $nama_kepsek; ?></div>
                </div>
                <div class="w-full text-center lg:w-[45%]">
                    ...
                    <div id="namaGuruCetak" class="ttd-placeholder mt-2 leading-loose underline font-bold">
                        <?= $nama_guru_bk; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="action-buttons-surat mt-8 pt-4 border-t border-gray-300 flex justify-center space-x-4">
                <button class="px-6 py-2 bg-[#0F3A3A] text-white rounded-lg font-semibold transition duration-300 hover:bg-indigo-700 w-1/2" onclick="window.print()">

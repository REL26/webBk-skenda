            ...
            Object.keys(menuItems).forEach(key => {
                ...
                const card = `
                    ${linkStart} class="relative overflow-hidden bg-white p-5 rounded-xl shadow-md hover:shadow-xl border border-gray-100 ${lockedClass}">
                        ...
                        ${!item.terkunci ? '<div class="mt-2 -mb-2 text-xs font-semibold text-blue-600 flex items-center gap-1 relative z-10"><span>Lihat Detail</span><i class="fas fa-arrow-right"></i></div>' : ''}
                    ${linkEnd}
                `;

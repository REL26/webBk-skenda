...
$interpretasi_gaya = [
    ...
    'Visual' => [
        'ciri' => 'Siswa lebih mudah memahami informasi melalui penglihatan seperti gambar, diagram, warna, dan tulisan.',
        'cara' => 'Gunakan media visual seperti catatan berwarna, mind map, grafik, dan ilustrasi.'
    ],

    'Auditori' => [
        'ciri' => 'Siswa lebih mudah memahami informasi melalui pendengaran, diskusi, dan penjelasan lisan.',
        'cara' => 'Gunakan metode diskusi, membaca dengan suara, dan penjelasan verbal.'
    ],

    'Kinestetik' => [
        'ciri' => 'Siswa lebih mudah memahami informasi melalui aktivitas, praktik, dan pengalaman langsung.',
        'cara' => 'Gunakan pembelajaran praktik, simulasi, dan kegiatan yang melibatkan gerakan.'
    ]
...
if($skor_v == $skor_tertinggi){
    $gaya_dominan_nama = 'Visual';
}
elseif($skor_a == $skor_tertinggi){
    $gaya_dominan_nama = 'Auditori';
}
else{
    $gaya_dominan_nama = 'Kinestetik';
}
...
<body class="bg-gray-50 antialiased leading-relaxed">
    ...
    <div id="main-content" class="flex items-center justify-center min-h-screen p-4">
        <div class="w-full max-w-2xl bg-white p-8 rounded-xl shadow-xl border border-gray-100">

            <h1 class="text-3xl font-extrabold text-gray-800 text-center mb-6">
                Laporan Siswa Ditemukan!
            </h1>

            <p class="text-lg text-gray-600 text-center mb-10">
                Anda sedang melihat laporan Gaya Belajar untuk siswa:
                <span class="font-bold text-[#1F5C5B]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <button id="openReportButton" class="
            block p-6 
            bg-[#1F5C5B]
            text-white
            rounded-xl
            ...
            ">
                ...
                <a href="javascript:void(0);" onclick="goBack()" class="
            block
            p-6
            bg-white
            border-2
    ...
    <div id="report-overlay">
        ...
        <div id="report-content" class="shadow-lg">
            ...
            <h4 class="section-title text-[11.5pt] font-bold text-left mt-5 pb-1 border-b border-black">1. HASIL SKOR
                GAYA BELAJAR:</h4>
    ...
    ?>
                ...
                <div class="data-visual-container mt-4">
                    ...
                    <table class="data-visual-table w-full text-left border border-black border-collapse">
                        ...
                        <tbody>
                            ...
                            <?php $highlight = ($row['skor'] == $skor_tertinggi) ? 'bg-gray-200 font-semibold' : ''; ?>
                            <tr class="<?= $highlight; ?>">
                                <td class="text-center py-2">
                                    <?= htmlspecialchars($row['nama']); ?>
                                </td>
                                <td class="text-center py-2">
                                    <?= htmlspecialchars($row['skor']); ?>
                                </td>
                                <td class="text-center py-2">
                                    <?= htmlspecialchars($row['persen']); ?>%
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <!-- Tabel Interpretasi -->
                    <table class="data-visual-table w-full text-left border border-black border-collapse mt-3">
                        <tbody>
                            <tr class="border-b border-black">
                                <td class="py-2 px-3 font-bold align-top w-[35%] bg-gray-200">Ciri Belajar</td>
                                <td class="py-2 px-3">
                                    <?= htmlspecialchars($interpretasi_gaya[$gaya_dominan_nama]['ciri']); ?>
                                </td>
                            </tr>
                            <tr>
                                <td class="py-2 px-3 font-bold align-top bg-gray-200">Saran Pembelajaran</td>
                                <td class="py-2 px-3">
                                    <?= htmlspecialchars($interpretasi_gaya[$gaya_dominan_nama]['cara']); ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="tanda-tangan mt-10 flex justify-between text-[10.5pt]">
                ...
                <div class="text-center w-[45%]">
                    ...
                    <div class="ttd-placeholder mt-2 leading-loose underline font-bold">
                        <?= $nama_kepsek; ?>
                    </div>
                </div>
                ...
                <div class="text-center w-[45%]">
                    ...
                    <select id="namaGuru" onchange="ubahGuru()" class="
            mt-3
            border
            border-gray-300
            rounded-lg
            ...
            focus:ring-teal-200
            ">
                        <option value="Pahrurazi, S.Pd">
                            Pahrurazi, S.Pd
                        </option>

                        <option value="Dian Riyani, S.Pd">
                            Dian Riyani, S.Pd
                        </option>

                        <option value="Putri Hidayatie, S.Pd">
                            Putri Hidayatie, S.Pd
                        </option>

                        <option value="Rini Rodhiati, S.Pd">
                            Rini Rodhiati, S.Pd
                        </option>
                        ...
                        <option value="Desy Arianti, S.Pd">
                            Desy Arianti, S.Pd
                        </option>

                        <option value="Khalisatun Ni'mah, S.Pd">
                            Khalisatun Ni'mah, S.Pd
                        </option>

                        <option value="Tiara Wulansari, S.Pd">
                            Tiara Wulansari, S.Pd
                        </option>

                        <option value="Dhea Nur Aziza, S.Pd">
                            Dhea Nur Aziza, S.Pd
                        </option>

                        <option value="Abdul Basith, S.Pd">
                            Abdul Basith, S.Pd
                        </option>

                    </select>
                    <div id="namaGuruCetak" class="
            ttd-placeholder
            mt-11
            leading-loose
            underline

...
<?php include __DIR__ . '/partials/sidebar.php'; ?>
  ...
  <div class="no-print mb-6">
    <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-2">
      <i class="fas fa-users-cog text-blue-600 mr-2"></i> Home Visit
    </h1>
    <p class="text-sm text-gray-600">Kelola kegiatan Home Visit</p>
  </div>
  ...
  <div class="flex-grow flex items-center justify-center">
    <div class="bg-white rounded-xl shadow-md p-10 md:p-14 flex flex-col items-center text-center max-w-md w-full">
      ...
      <h2 class="text-xl font-bold text-gray-800 mb-2">Fitur Home Visit</h2>
      <p class="text-sm text-gray-500 mb-6 leading-relaxed">
        Halaman ini sedang dalam tahap pengembangan aktif. Fitur Home Visit akan segera tersedia.
      </p>

...
<body class="bg-slate-50 text-slate-800 min-h-screen">
    ...
    <div id="mobileMenu"
        class="fade-slide hidden-transition fixed top-[64px] left-0 w-full bg-white shadow-lg z-30 md:hidden flex flex-col text-sm max-h-[calc(100vh-64px)] overflow-y-auto">
        <a href="dashboard.php"
            class="py-3 px-5 text-gray-700 hover:bg-gray-50 transition flex items-center gap-2 <?php echo $current_page == 'dashboard.php' ? 'bg-gray-100 font-bold' : ''; ?>">
        ...
        <div class="py-3 px-5 text-gray-700 hover:bg-gray-50 transition cursor-pointer <?php echo $is_profiling_active ? 'bg-gray-100 font-medium' : ''; ?>"
            ...
            <div class="flex items-center justify-between">
                ...
                <i id="profilingSubmenuMobileIcon"
                    class="fas fa-chevron-down text-xs transition-transform duration-300 <?php echo $is_profiling_active ? 'fa-chevron-up' : ''; ?>"></i>
            </div>
        </div>
        <div id="profilingSubmenuMobile"
            ...
            <a href="hasil_tes.php"
                class="block py-2 px-5 text-gray-700 hover:bg-gray-100 transition flex items-center gap-2 <?php echo $current_page == 'hasil_tes.php' ? 'text-teal-600 font-semibold' : ''; ?>">
                <i class="fas fa-list-alt w-4"></i> Data Hasil Persiswa
            </a>
            <a href="rekap_kelas.php"
                class="block py-2 px-5 text-gray-700 hover:bg-gray-100 transition flex items-center gap-2 <?php echo $current_page == 'rekap_kelas.php' ? 'text-teal-600 font-semibold' : ''; ?>">
                <i class="fas fa-chart-bar w-4"></i> Data Hasil Perkelas
            </a>
        </div>
        <hr class="border-gray-200">

        <div class="py-3 px-5 text-gray-700 hover:bg-gray-50 transition cursor-pointer"
        ...
        <div id="programBkSubmenuMobile"
            class="pl-8 space-y-1 py-1 bg-gray-50 border-t border-b border-gray-100 hidden">
            <a href="konselingindividu.php"
                class="block py-2 px-5 text-gray-700 hover:bg-gray-100 transition flex items-center gap-2">
        ...
        <a href="logout.php"
            class="bg-gradient-to-r from-red-500 to-red-600 text-white py-4 hover:from-red-600 hover:to-red-700 transition text-sm font-medium flex items-center justify-center gap-2">
    ...
    <div class="flex">
        ...
        <aside id="sidebar" class="sidebar hidden md:flex primary-gradient shadow-2xl z-40 flex-col text-white">
            ...
            <nav class="flex flex-col flex-grow py-4 space-y-1 px-3">
                <a href="dashboard.php"
                    class="flex items-center px-4 py-3 text-sm font-medium text-gray-200 hover:bg-white/10 rounded-lg transition duration-200 <?php echo $current_page == 'dashboard.php' ? 'bg-white/10 text-white shadow-inner' : ''; ?>">
                    <i class="fas fa-home mr-3 w-5"></i> Dashboard
                </a>

                <div class="nav-item cursor-pointer" onclick="toggleSubMenu('profilingSubmenuDesktop')">
                    <div
                        class="flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-200 hover:bg-white/10 rounded-lg transition duration-200 <?php echo $is_profiling_active ? 'text-white' : ''; ?>">
                ...
                <div id="profilingSubmenuDesktop"
                    ...
                    <a href="hasil_tes.php"
                        class="flex items-center px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition duration-200 <?php echo $current_page == 'hasil_tes.php' ? 'text-white font-semibold bg-white/10' : ''; ?>">
                        <i class="fas fa-list-alt mr-3 w-4"></i> Data Hasil Persiswa
                    </a>
                    <a href="rekap_kelas.php"
                        class="flex items-center px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition duration-200 <?php echo $current_page == 'rekap_kelas.php' ? 'text-white font-semibold bg-white/10' : ''; ?>">
                ...
                <div class="nav-item cursor-pointer" onclick="toggleSubMenu('programBkSubmenuDesktop')">
                    <div
                        ...
                        <i id="programBkSubmenuDesktopIcon"
                            class="fas fa-chevron-down text-xs ml-2 transition-transform duration-300"></i>
                    </div>
                </div>
                ...
                <div class="mt-auto pt-4 border-t border-white/10">
                    <a href="logout.php"
                        class="flex items-center px-4 py-3 text-sm font-medium text-red-200 hover:bg-red-600/30 rounded-lg transition duration-200">

...
$daftar_gaya = [];
if ($siswa['skor_visual'] !== null && $siswa['skor_visual'] !== '') {
    ...
    if ($skor_v == $skor_tertinggi) $daftar_gaya[] = 'Visual';
    if ($skor_a == $skor_tertinggi) $daftar_gaya[] = 'Auditorial';
    if ($skor_k == $skor_tertinggi) $daftar_gaya[] = 'Kinestetik';
    $gaya_belajar = implode(" & ", $daftar_gaya);
}
...
$app_base_url = "https://bk.kulakoding.com/";
...
// URL tombol "Kembali" -> menyesuaikan id_siswa otomatis
...
<title>CV Siswa - <?php echo $nama_lengkap; ?></title>
    ...
    <td width="36%" style="width:36%;vertical-align:top;padding:22px 16px 22px 24px;border-right:1px solid #dde3ea;background-color:#f5f7fa;">
        ...
        <tr><td style="padding-top:10px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;table-layout:fixed;">
                ...
                foreach ($daftar_tipe_kemampuan as $tipe):
